...
} = require('../controllers/moims');
const { createLike, getLikedMoims, deleteLike } = require('../controllers/likes');
const {
  getAllComments, getTargetMoimComments, createComment, updateComment, deleteComment, myComments,
...
// chat
const {
  createChatRoom, enterChatRoom, exitChatRoom, deleteChatRoom, loadTargetChat, saveChat, getAllNotice, makeNotice, updateNotice, deleteNotice, getTargetNotice,
